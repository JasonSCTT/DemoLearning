...
import com.jason.control.UserController;
...
//        printClassMethodMessage(UserController.class);
        printFieldMessage(UserController.class);
        printConMessage(UserController.class);
    }
